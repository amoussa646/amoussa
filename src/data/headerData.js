import resume from "../assets/pdf/Abdallah.Moussa.CV.pdf";
import profileImage from "../assets/png/displayPic.jpeg"; // Adjust the path and file name accordingly
// A multifaceted engineer
export const headerData = {
  name: "Abdallah Moussa",
  // title: "A zealous engineer leveraging expertise from diverse domains.",
  desciption:
